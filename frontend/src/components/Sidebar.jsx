  ...
  return (
    <div className="flex flex-col justify-between w-[250px] rounded-md bg-[#15161f] p-2 h-[calc(100vh-86px)] overflow-auto">
      <div>
        ...
        <h3 className="text-lg font-bold py-1 rounded border-b-2 border-[#52545f] mb-2">
          Active users
        </h3>
        ...
        <div className="flex flex-col gap-2 h-full">
          {clients.map((client) => (
            <div className="flex items-center gap-1" key={client.socketId}>
              ...
              <span className="text-[12px] wrap-break-words leading-tight">
                {client.username}
              </span>
            </div>
          ))}
      ...
      <div className="flex flex-col gap-3 text-black font-semibold mt-8">
        <button
          className="flex items-center justify-center gap-2 bg-white/90 border border-white/15 rounded p-1 cursor-pointer"
          onClick={() => navigate(`/project/${roomId}/details`)}
        >
        ...
        <button
          className="bg-[#4aed88]/90 p-1 rounded cursor-pointer"
          onClick={copyRoomId}
        >
          Copy Room Id
        </button>
        ...
        <button
          className="bg-red-400/90 p-1 rounded cursor-pointer"
          onClick={leaveRoom}
        >
          Leave Room{" "}
        </button>
